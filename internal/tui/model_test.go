...
// mixedProjectSessions puts both sessions in the same project group so it
// carries one active and one saved session, letting auto-fold hide the saved
// one behind a more row.
